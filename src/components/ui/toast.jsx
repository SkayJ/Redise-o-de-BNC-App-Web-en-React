...
// CONTEXTO INTERNO PARA CONTROLAR EL CIERRE
const ToastContext = React.createContext({
  onClose: () => {},
});

// COMPONENTE TOAST CON AUTO-CERRADO (10 SEGUNDOS)
const Toast = React.forwardRef(({ className, variant, ...props }, ref) => {
  ...
  // Temporizador automático de 10 segundos (10000 ms)
  React.useEffect(() => {
...
// BOTÓN X CON ACCIÓN REAL DE CIERRE COMPORTAMENTAL
  ...
  return (
    <button
      ...
      onClick={(e) => {
        ...
        onClose(); // Ejecuta el cierre inmediato
      }}
      {...props}
    >
      <X className="h-4 w-4" />
